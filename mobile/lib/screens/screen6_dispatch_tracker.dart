                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text('Team has not moved in 30 min. Reminder sent.', style: TextStyle(color: Colors.black87)),
                          const SizedBox(height: 4),
                          Text('Agent A4 • Just now', style: TextStyle(color: Colors.grey[600], fontSize: 12)),
                        ],
                      ),
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: isActive ? AppTheme.accentBlue : (isCompleted ? Colors.black87 : Colors.grey),
                              ),
                            ),
                          ),
                        ),
